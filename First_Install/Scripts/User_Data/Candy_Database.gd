...
var actors = {
	"Player": {								#/ Reference used in dialogue lines.
		"ShortName": "",					#/ Optional key, has no built-in use. A value may be assigned and used or displayed in text or anywhere in the game.
		"DisplayName": "",					#/ Name as displayed on screen (displays the actor reference if empty).
		"SpeakerBBCode": ["", ""],			#/ Optional BBCode formatting added to the Display Name when actor speaks.
		...
		"PortraitOverride": 0,				#/ -1 = never show portrait; 0 = use default settings; 1 = always show portrait.
		"BubblesOverride": 0,				#/ -1 = never use speech bubbles; 0 = use default settings; 1 = always use speech bubbles.
		"VNJoinEffect": ["", ""],			#/ VN Mode: The animation to play on bust nodes when this actor joins/moves/leaves;
		"VNMoveFromEffect": ["", ""],		#/ Overrides general and VN scene settings if value is not "".
		"VNMoveToEffect": ["", ""],			#/ ["Method", "Value"] (e.g. ["Animation", "Fade Out"]).
		"VNLeaveEffect": ["", ""],
		...
		"BoxTextColor": null,				#/ Color of the spoken text for this actor in Box mode. Uses BBCode tags. Overrides all other settings.
		"BoxSpeakerColor": null,			#/ Color of the speaker label for this actor in Box mode. Uses BBCode tags. Overrides all other settings.
		"BubbleTextColor": null,			#/ → Same, in Bubbles mode.
		"SubtitleTextColor": null,			#/ → Same, in Subtitles mode.
		"SubtitleSpeakerColor": null,
		"ChatTextColor": null,				#/ → Same, in Chat mode.
		"ChatSpeakerColor": null,
		"BarkTextColor": null,				#/ → Same, in Bark mode.
	},
	"Alice": {
		"ShortName": "Alice",
